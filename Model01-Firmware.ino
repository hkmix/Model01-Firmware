...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  [LEFT_FN] = KEYMAP_STACKED(
    ...
    M(MACRO_VERSION_INFO),  Key_KeypadDivide,   Key_Keypad7, Key_Keypad8, Key_Keypad9,   Key_KeypadAdd, ___,
    ___,                    Key_KeypadMultiply, Key_Keypad4, Key_Keypad5, Key_Keypad6,   Key_KeypadAdd, ___,
                            Key_KeypadSubtract, Key_Keypad1, Key_Keypad2, Key_Keypad3,   Key_Equals,    ___,
    ___,                    Key_KeypadSubtract, Key_Keypad0, Key_Keypad0, Key_KeypadDot, Key_Equals,    ___,
